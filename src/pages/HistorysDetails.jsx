...
const newsData = [
    {
        ...
        date: "2024-12-17",
        views: 84,
        description: 'Sho‘rlangan tuproqlar tarkibidagi tuzlarni samarali yuvuvchi, "Biosolvent" preparati loyihasini amalga oshirish maqsadida "Innovatsion Bio Texnologiyalar" MChJ tashkil qilinib, maxalliy va import hom ashyolar sotib olindi. Xozirda ishlab chiqarish uchun uskunalar o‘rnatildi hamda ishlab chiqarish yo‘lga qo‘yilib, "Innovatsion Bio Texnologiyalar" MChJga "Yashnobod" texnopark rezidenti maqomi berildi.',
